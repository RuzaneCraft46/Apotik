...
<head>
  <meta charset="UTF-8">
  <title>Login | Aplikasi Stok Persediaan Obat</title>
...
<body class="login-page bg-login">
  <div class="login-box">
    <div style="color:#3c8dbc" class="login-logo">
      <img style="margin-top:-50px" src="assets/img/prestasiprima.png" alt="Logo" height="100"> <b></b>
      <br>
      <center>
        <p><b>PERSEDIAAN OBAT "Apotek Presma"</a></p>
      </center></b>
    </div><!-- /.login-logo -->
    <?php
